                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center justify-end space-x-2">
                                                <Link :href="route('web.computers.show', computer.id_computer)" 
                                                      class="inline-flex items-center justify-center p-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg">
                                                    Ver
                                                </Link>
                                                <Link :href="route('web.computers.edit', computer.id_computer)" 
                                                      class="inline-flex items-center justify-center p-2 bg-black hover:bg-gray-800 text-white rounded-lg">
                                                    Editar
                                                </Link>
                                                <form @submit.prevent="deleteComputer(computer)" class="inline-block">
                                                    <button type="submit" 
                                                            class="inline-flex items-center justify-center p-2 bg-red-600 hover:bg-red-700 text-white rounded-lg">
                                                        Eliminar
                                                    </button>
                                                </form>
                                            </div>
