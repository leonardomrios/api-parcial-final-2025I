                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                            ...
                            <div class="flex items-center justify-between w-full sm:w-auto gap-4">
                                ...
                                <a href="{{ route('web.categories.create') }}" 
                                   class="inline-flex items-center px-4 py-2 bg-green-600 dark:bg-green-700 border border-transparent rounded-md font-semibold text-xs text-white dark:text-gray-100 uppercase tracking-widest hover:bg-green-700 dark:hover:bg-green-600 focus:bg-green-700 active:bg-green-900 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                ...
                                @forelse($categories as $category)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                            <a href="{{ route('web.categories.show', $category->id_category) }}" class="font-medium text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300 hover:underline">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                            ...
                                            @else
                                                <span class="text-gray-400 dark:text-gray-500 text-xs">Sin descuento</span>
                                            @endif
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                                            <a href="{{ route('web.categories.show', $category->id_category) }}" 
                                               class="inline-flex items-center justify-center px-3 py-1.5 rounded-lg font-semibold text-sm transition-colors duration-150
                                                      {{ $category->computers_count > 0 ? 'bg-indigo-100 dark:bg-indigo-900 text-indigo-800 dark:text-indigo-200 hover:bg-indigo-200 dark:hover:bg-indigo-800' : 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400' }}"
