    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('web.computers.update', $computer->id_computer) }}" class="space-y-6">
                        @csrf
                        @method('PUT')

                        <div>
                            <label for="computer_brand" class="block text-sm font-medium text-gray-700">Marca <span class="text-red-500">*</span></label>
                            <input type="text" name="computer_brand" id="computer_brand" value="{{ old('computer_brand', $computer->computer_brand) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="computer_model" id="computer_model" value="{{ old('computer_model', $computer->computer_model) }}"
                                required minlength="2" maxlength="100"
                        ...
                        <div>
                            ...
                            <select name="category_id" id="category_id" required
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->id_category }}" {{ old('category_id', $computer->category_id) == $category->id_category ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" name="computer_ram_size" id="computer_ram_size" value="{{ old('computer_ram_size', $computer->computer_ram_size) }}"
                            ...
                            <div>
                                ...
                                <input type="number" name="computer_price" id="computer_price" value="{{ old('computer_price', $computer->computer_price) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="computer_barcode" id="computer_barcode" value="{{ old('computer_barcode', $computer->computer_barcode) }}"
                                maxlength="50"
                            ...
                            <p class="mt-1 text-xs text-gray-500">Opcional, máximo 50 caracteres</p>
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-6">
                                <label class="flex items-center">
                                    <input type="radio" name="computer_is_laptop" value="1" {{ old('computer_is_laptop', $computer->computer_is_laptop) == '1' ? 'checked' : '' }} required
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="computer_is_laptop" value="0" {{ old('computer_is_laptop', $computer->computer_is_laptop) == '0' ? 'checked' : '' }}
                                        class="rounded-full border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    <span class="ml-2 text-sm text-gray-700">
