                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center justify-end space-x-3 mt-6 pt-6 border-t">
                        <a href="{{ route('web.computers.edit', $computer->id_computer) }}" 
                            class="inline-flex items-center px-4 py-2 bg-black border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-800 transition">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
